...
<div id="table-list_wrapper" class="data-table"><div class="row"><div class="col-sm-6"><div class="dataTables_length" id="table-list_length"><label>Show <select name="table-list_length" aria-controls="table-list" class="form-control input-sm"><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select> entries</label></div></div><div class="col-sm-6"><div id="table-list_filter" class="dataTables_filter"><label>Search:<input type="search" class="form-control input-sm" placeholder="" aria-controls="table-list"></label></div></div></div><div class="row"><div class="col-sm-12"><table id="table-list" class="table table-striped table-bordered data-table dataTable" cellspacing="0" width="100%" role="grid" aria-describedby="table-list_info" style="width: 100%;">
      <thead>
